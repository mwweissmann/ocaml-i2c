(* OASIS_START *)
(* DO NOT EDIT (digest: 654a7e792f2de6145be6ec1d46ac6571) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("i2c", ["src"], [])];
     lib_c = [("i2c", "src", ["src/i2c-dev.h"])];
     flags =
       [
          (["oasis_library_i2c_ccopt"; "compile"],
            [
