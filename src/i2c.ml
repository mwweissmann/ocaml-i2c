...
external read_byte_data : t -> Stdint.uint8 -> (Stdint.uint8 list, [> `EUnix of Unix.error ]) Result.result = "wrap_i2c_smbus_read_byte_data"
external read_byte : t -> (Stdint.uint8 list, [> `EUnix of Unix.error ]) Result.result = "wrap_i2c_smbus_read_byte"
