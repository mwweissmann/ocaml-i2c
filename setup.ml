...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5f634f23579ce73d9a53170c5e2e446a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/mwweissmann/ocaml-i2c/";
          bugreports = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["i2c_stubs.c"; "i2c-dev.h"];
                      bs_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for i2c-dev";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "i2c"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "mcp23017.ml"})
            ];
     ...
     oasis_digest = Some "\127\146\"\011\021n6J\006\029\210\197)\178\155O";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
